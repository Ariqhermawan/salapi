...
export default function WithdrawScreen() {
  ...
  return (
    <div style={shell}>
      ...
      <div style={{ padding: "14px 16px 0", display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
      ...
      <div style={{ padding: "14px 16px 0" }}>
        <div style={{ padding: "12px 14px", background: T.surface, borderRadius: 12, boxShadow: "inset 0 0 0 1px " + T.hairline, display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ marginTop: 10, padding: "10px 12px", borderRadius: 10, background: T.warnTint, color: T.warn, display: "flex", gap: 10, alignItems: "flex-start" }}>
